<%@ Page Title="Verify Certificate" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Verify.aspx.cs" Inherits="PrepReady.Verify" %>
    ...
    <section class="pr-section">
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-lg-7">
                    <p class="pr-eyebrow mb-1">Credential check</p>
                    <h1 class="pr-section-title">Verify a Certificate</h1>
                    <p class="text-muted">Enter a Certificate ID (or scan its QR code) to confirm authenticity.</p>

                    <div class="input-group mb-4">
                        <asp:TextBox ID="txtCode" runat="server" CssClass="form-control" placeholder="e.g. PR1-AB12CD34" />
                        <asp:Button ID="btnCheck" runat="server" CssClass="pr-btn-accent" Text="Verify" OnClick="btnCheck_Click" />
                    </div>

                    <asp:Label ID="lblNotFound" runat="server" CssClass="alert alert-danger d-block" Visible="false"
                               Text="No certificate matches that ID." />

                    <asp:Panel ID="pnlResult" runat="server" Visible="false">
                        <div class="card">
                            <div class="card-body p-4">
                                <div class="d-flex justify-content-between align-items-start mb-2">
                                    <div class="pr-verify-head">
                                        <svg class="pr-verify-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M12 3 20 6v5c0 5-3.5 8-8 10-4.5-2-8-5-8-10V6l8-3Z"/><path d="M9 12l2 2 4-4"/></svg>
                                        <h2 class="h4 mb-0"><asp:Literal ID="litName" runat="server" /></h2>
                                    </div>
                                    <asp:Literal ID="litStatus" runat="server" />
                                </div>
                                <hr />
                                <dl class="row mb-0 pr-detail">
                                    <dt class="col-sm-4">Recognised field</dt><dd class="col-sm-8"><asp:Literal ID="litCourse" runat="server" /></dd>
                                    <dt class="col-sm-4">Tier</dt><dd class="col-sm-8"><asp:Literal ID="litTier" runat="server" /></dd>
                                    <dt class="col-sm-4">Endorsing agency</dt><dd class="col-sm-8"><asp:Literal ID="litPartner" runat="server" /></dd>
                                    <dt class="col-sm-4">Issued</dt><dd class="col-sm-8"><asp:Literal ID="litIssue" runat="server" /></dd>
                                    <dt class="col-sm-4">Valid until</dt><dd class="col-sm-8"><asp:Literal ID="litExpiry" runat="server" /></dd>
                                    <dt class="col-sm-4">Certificate ID</dt><dd class="col-sm-8"><asp:Literal ID="litCode" runat="server" /></dd>
                                </dl>
                                <div class="text-center mt-4">
                                    <span class="pr-qr-box">
                                        <img id="imgQr" runat="server" alt="Certificate QR code" style="width:140px;height:140px;display:block;" />
                                    </span>
                                    <p class="small text-muted mt-2 mb-0">Scan to open this verification page</p>
                                </div>

                                <%-- ===== EX-13: share this verified credential ===== --%>
                                <hr />
                                <div class="pr-share d-flex align-items-center flex-wrap gap-2"
                                     data-url="self"
                                     data-text="This credential is verified on the PrepReady National Recognised Responders Registry.">
                                    <span class="small text-muted me-1">Share this result:</span>
